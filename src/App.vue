...
<script>
import { mapGetters } from 'vuex'; // // vuex 에서 개발자가 선언한 Data 를 가져오기 위한 mapGetter helper
...
export default {
  ...
  computed: {
    ...
    ...mapGetters({ // parameter 로 넘긴 json 값을 가지고 개발자가 만들어둔 Getter 를 꺼내와서 computed 로 사용할 수 있는 json 객체를 return 한다.
      chatList: 'chatList'
    })
  },
  methods: {
